...
public class NotificationPreferenceService {
    ...
    public List<NotificationPreferenceResponse> update(Long userId, List<NotificationPreferenceRequest> requests) {
        ...
        if (requests == null) {
            throw new BadRequestException("Danh sách tuỳ chọn không được để trống");
        }
        ...
        for (NotificationPreferenceRequest request : requests) {
            ...
            if (type == null) {
                throw new BadRequestException("Loại thông báo không hợp lệ: " + (request == null ? null : request.type()));
            }
